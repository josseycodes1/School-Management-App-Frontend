    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="bg-white shadow-sm py-4 px-4 md:px-6 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex space-x-2 md:space-x-4">
          <Link href="/log-in" className="px-3 py-1 md:px-4 md:py-2 text-[#FC46AA] font-medium hover:text-[#F699CD] transition-colors text-sm md:text-base">
            Login
          </Link>
          <Link href="/sign-up" className="px-3 py-1 md:px-4 md:py-2 bg-[#FC46AA] text-white rounded-md hover:bg-[#F699CD] transition-colors text-sm md:text-base">
            Sign Up
          </Link>
        </div>
      </nav>
