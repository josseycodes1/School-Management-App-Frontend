    ...
    <section className="relative min-h-[500px] flex items-center justify-center py-20 px-4 text-center">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-6">
          <Link href="/log-in" className="px-8 py-3 bg-white text-josseypink1 hover:bg-josseypink10 rounded-lg transition-all duration-300 font-medium shadow-lg">
            Log In
          </Link>
          <Link href="/sign-up" className="px-8 py-3 border-2 border-white text-white rounded-lg hover:bg-josseypink10  hover:text-josseypink1 transition-all duration-300 font-medium shadow-lg">
            Sign Up
          </Link>
        </div>
      </div>
