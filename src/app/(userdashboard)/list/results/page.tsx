...
const StudentResultsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-josseypink2 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center">
              <div className="w-12 h-12 bg-josseypink2 rounded-lg flex items-center justify-center mr-4">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center">
              <div className="w-12 h-12 bg-josseypink2 rounded-lg flex items-center justify-center mr-4">
                <svg className="w-6 h-6 text-josseypink1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
