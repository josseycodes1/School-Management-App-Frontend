...
const AdmissionPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="pt-20"> {/* Adjusted padding to account for fixed navbar */}
                ...
                <form onSubmit={handleWaitlistSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-josseypink1 focus:border-josseypink1 transition-colors duration-200"
                  ...
                  <button
                    type="submit"
                    className="w-full bg-josseypink1 text-white py-3 rounded-lg hover:bg-josseypink2 transition-colors duration-200 font-semibold"
                  >
                    Join Waitlist
                  </button>
                </form>
            ...
            <div>
              <div className="bg-white rounded-xl shadow-md p-6 mb-6">
                ...
                <div className="space-y-6">
                  <div className="border border-gray-200 rounded-lg p-4 hover:border-josseypink1 transition-colors duration-200">
                    ...
                    <div className="flex space-x-3">
                      <Link 
                        href="/login/student" 
                        className="flex-1 bg-gray-100 text-gray-800 py-2 rounded-lg text-center hover:bg-josseypink1 hover:text-white transition-colors duration-200 font-medium"
                      >
                        Login
                      </Link>
                      <Link 
                        href="/signup/student" 
                        className="flex-1 border border-josseypink1 text-josseypink1 py-2 rounded-lg text-center hover:bg-josseypink1 hover:text-white transition-colors duration-200 font-medium"
                      >
                        Sign Up
                      </Link>
                    </div>
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center group">
                    <svg className="w-5 h-5 text-josseypink1 mr-3 group-hover:text-josseypink2 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    <span className="text-gray-700 group-hover:text-josseypink1 transition-colors duration-200">(555) 123-4567</span>
                  </div>
                  <div className="flex items-center group">
                    <svg className="w-5 h-5 text-josseypink1 mr-3 group-hover:text-josseypink2 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <span className="text-gray-700 group-hover:text-josseypink1 transition-colors duration-200">admissions@schoolname.edu</span>
                  </div>
                  <div className="flex items-center group">
                    <svg className="w-5 h-5 text-josseypink1 mr-3 group-hover:text-josseypink2 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="text-gray-700 group-hover:text-josseypink1 transition-colors duration-200">123 Education Street, City, State 12345</span>
                  </div>
                </div>
              </div>
            </div>
